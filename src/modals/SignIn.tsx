...
import {IUser, signInAsync} from "../user/userSlice";
...
const SignIn = (props: any) => {
    ...
    const onSubmit = async (user: IUser) => {
        const data = await dispatch(signInAsync(user));
        // @ts-ignore
            ...
            <Modal isOpen={props.isOpen} onAfterOpen={afterOpenModal} onRequestClose={closeModal} style={customStyles}>
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div>
                        ...
                        <input className={styles['modal__input']} type={"password"}
                               placeholder={"password"} {...register("password", {required: true})}/>
                    </div>
                    <input className={styles.modal__btn_white} type="submit" value="Sign in"/>
                </form>
